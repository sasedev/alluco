 ...
 */
class F50ALTForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('widthLR', 'integer', array('label' => 'Quotation.widthLR.label', 'required' => true, 'data' => 0, 'constraints' => array(new GreaterThan(array('value' => 0)))));
