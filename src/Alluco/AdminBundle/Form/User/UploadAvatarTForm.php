...
class UploadAvatarTForm extends AbstractType
{
    ...
    {
        $builder->add('avatar', 'file', array('label' => 'User.avatar.label', 'constraints' => array(new Image(array('mimeTypes' => array('image/jpg', 'image/jpeg', 'image/pjpeg'),'maxSize' => "4096k"))), 'mapped' => false));
    }
