...
class UpdateThumbInfoTForm extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder->add('thumbAlt', 'text', array('label' => 'SitenewTrans.thumbAlt.label'));

        $builder->add('thumbTitle', 'text', array('label' => 'SitenewTrans.thumbTitle.label', 'required' => false));
    ...
    public function getName()
    {
        ...
        return 'SitenewTransUpdateThumbInfoForm_'.$this->formName;
